...
void eyelid_set(eyelid_position option) {
    switch (option) {
        case EYELID_CLOSED:
            set_smooth_servo_angle(EYELID_CLOSE, 0);
            set_smooth_servo_angle(EYELID_TILT, 90);
            break;
        case EYELID_CENTER:
            set_smooth_servo_angle(EYELID_CLOSE, 120);
            set_smooth_servo_angle(EYELID_TILT, 90);
            break;
        case EYELID_DOWN:
            break;
...
void eyebrow_set(eyebrow_position option) {
    switch (option) {
        ...
        case EYEBROW_RIGHTRAISE:
            set_smooth_servo_angle(LEFT_EYEBROW_LEFT, 90);
            set_smooth_servo_angle(LEFT_EYEBROW_RIGHT, 90);
            set_smooth_servo_angle(RIGHT_EYEBROW_LEFT, 45);
            set_smooth_servo_angle(RIGHT_EYEBROW_RIGHT, 135);
            break;
